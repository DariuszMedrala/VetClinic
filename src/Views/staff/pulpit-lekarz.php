...
<?php foreach ($upcoming as $a): ?>
            <tr data-row="<?= e((string) $a->id) ?>">
              ...
              <td><button class="btn btn--primary btn--sm js-complete" data-id="<?= e((string) $a->id) ?>">Zakończ</button></td>
            </tr>
<?php endforeach; ?>
          </tbody>
        </table>
...
<?php else: ?>
        <table class="schedule">
          <thead><tr><th>Data</th><th>Pacjent</th><th>Powód</th><th>Akcja</th></tr></thead>
          <tbody>
