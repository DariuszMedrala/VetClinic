<main class="auth" style="grid-template-columns:1fr;place-items:center;">
  <section class="auth__panel" style="max-width:460px;text-align:center;">
    ...
    <h2 class="auth__title">Zalogowano pomyślnie</h2>
    <p class="auth__subtitle">
      <strong><?= e($user['name']) ?></strong><br>
      Rola w systemie: <strong><?= e($user['role']) ?></strong>
    </p>
    <form method="post" action="/logout">
      <input type="hidden" name="_csrf" value="<?= e(\App\Core\Csrf::token()) ?>">
      <button class="btn btn--primary btn--block btn--lg" type="submit">Wyloguj się</button>
    </form>
  </section>
</main>
